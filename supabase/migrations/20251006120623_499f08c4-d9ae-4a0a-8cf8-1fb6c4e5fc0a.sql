-- Drop existing receipt_companies table if it exists
DROP TABLE IF EXISTS public.receipt_companies CASCADE;

-- Create receipt_companies table
...
-- Ensure storage bucket exists for company logos
