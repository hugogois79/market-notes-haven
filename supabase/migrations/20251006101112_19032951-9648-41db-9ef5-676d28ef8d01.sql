...
-- This migration safely handles existing policies and creates new authenticated-only policies
...
DROP POLICY IF EXISTS "Authenticated users can view contact logs" ON public.tao_contact_logs;
DROP POLICY IF EXISTS "Authenticated users can insert contact logs" ON public.tao_contact_logs;
DROP POLICY IF EXISTS "Authenticated users can update contact logs" ON public.tao_contact_logs;
DROP POLICY IF EXISTS "Authenticated users can delete contact logs" ON public.tao_contact_logs;
...
DROP POLICY IF EXISTS "Authenticated users can view tao notes" ON public.tao_notes;
DROP POLICY IF EXISTS "Authenticated users can insert tao notes" ON public.tao_notes;
DROP POLICY IF EXISTS "Authenticated users can update tao notes" ON public.tao_notes;
DROP POLICY IF EXISTS "Authenticated users can delete tao notes" ON public.tao_notes;
...
DROP POLICY IF EXISTS "Authenticated users can view validator subnets" ON public.tao_validator_subnets;
DROP POLICY IF EXISTS "Authenticated users can insert validator subnets" ON public.tao_validator_subnets;
DROP POLICY IF EXISTS "Authenticated users can update validator subnets" ON public.tao_validator_subnets;
DROP POLICY IF EXISTS "Authenticated users can delete validator subnets" ON public.tao_validator_subnets;
