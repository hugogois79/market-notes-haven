...
import { Check, Shield, ExternalLink, Download } from 'lucide-react';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md dark:bg-[#1A1D21] border dark:border-gray-700 p-0 overflow-hidden">
        ...
        <div className="p-5">
          <h4 className="text-sm font-medium mb-3">Benefits of installing the app:</h4>
          ...
          <div className="space-y-3 mb-5">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm font-medium">Dedicated app experience</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Faster load times and better experience</p>
              </div>
            </div>
          </div>
        ...
        <DialogFooter className="flex sm:justify-between border-t border-gray-200 dark:border-gray-700 p-4">
          <Button
            type="button"
            variant="outline"
            size="sm"
