          ...
          <body>
            ...
            <div class="page">
              <div class="header">
                <div class="header-left">
                  <div class="header-logo">
                    ${logoBase64 ? `<img src="${logoBase64}" alt="Robsonway" />` : '<span style="font-size: 24px; font-weight: 700;">R</span>'}
                  </div>
                  <div class="header-info">
                    <h1>Expense Request #${claim.claim_number}</h1>
                    <p>Robsonway - Ethical Business Solutions</p>
                  </div>
                </div>
              ...
              <div class="page-footer">
                <div class="brand">
                  <span>Generated by Robsonway Expense Management</span>
                </div>
                <div>
            ...
            ${receipts.flatMap((receipt, receiptIndex) => 
              receipt.images.map((imageUrl, pageIndex) => `
                <div class="receipt-page">
                  ...
                  <div class="page-footer">
                    <div class="brand">
                      <span>Robsonway Expense Management</span>
                    </div>
                    <div>
